...
require (
	github.com/dreamph/dbre v0.0.4
	github.com/dreamph/dbre/adapters/bun v0.0.0-20250110102315-4f8217184e79
...
require (
	...
	github.com/dreamph/dbre/adapters/gorm v0.0.0-00010101000000-000000000000 // indirect
